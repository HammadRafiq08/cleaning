            ...
            <div class="modal-body">
                <form id="image_form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="Enter First Name">Title</label>
                        ...
                        <select class="form-control" name="category">
                            ...
                            <option value="Room items Cleaning">Room items Cleaning</option>
                            <option value="Kitchen items Cleaning">Kitchen items Cleaning</option>
                            <option value="Wooden Items Cleaning">Wooden Items Cleaning</option>
                            <option value="Other Items Cleaning">Other Items Cleaning</option>
                        </select>
                        </div>
