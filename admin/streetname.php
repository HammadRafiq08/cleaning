            ...
            <div class="modal-body">
                <form id="image_form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="Enter First Name">Street Name</label>
                        <input class="form-control" type="text" name="name"  placeholder="Enter Street Name">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Suburb</label>
                        <select class="form-control" name="suburb">
                          <?php
                          $query = "SELECT `name` FROM `suburb`";
