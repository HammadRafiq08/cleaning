            ...
            <div class="modal-body">
                <form id="image_form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="Enter First Name">Question</label>
                        <textarea class="ckeditor" type="text" id="usingckeditor" cols="30" rows="10" style="resize:none;"></textarea>
                        </div>
                        <div class="form-group">
                        <label for="Enter First Name">Answer</label>
                        <textarea class="ckeditor" type="text" id="usingckeditorans" cols="30" rows="10" style="resize:none;"></textarea>
                        </div>
...
<script>
  ...
  $("#search").on('input',function(){
        ...
        $('#image_form').submit(function(event){
            ...
            data.append('question', CKEDITOR.instances['usingckeditor'].getData());
            data.append('answer', CKEDITOR.instances['usingckeditorans'].getData());
                    $.ajax({
                        url:"faq_action.php",
                        method:"POST",
                        data:data,
