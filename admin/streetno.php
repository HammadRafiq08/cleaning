            ...
            <div class="modal-body">
                <form id="image_form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="Enter First Name">Street Number</label>
                        <input class="form-control" type="text" name="name"  placeholder="Enter Street Number">
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Street Name</label>
                        <select class="form-control" name="streetname">
                          <?php
                          $query = "SELECT `name` FROM `streetname`";
