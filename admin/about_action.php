...
if(isset($_POST["action"]))
{
  ...
  $i=0;
   ...
   ';
    ...
    {
        $name = mysqli_real_escape_string($connect,$_POST['heading']);
        $desc = mysqli_real_escape_string($connect,$_POST['description']);
        $file = addslashes(file_get_contents($_FILES["image"]["tmp_name"]));
        $query = "UPDATE $tablename SET `image` = '$file',`heading` = '$name',`description` = '$desc'  WHERE id = '".$_POST["image_id"]."'";
