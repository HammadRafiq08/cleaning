   ...
   ';
    ...
    if($_POST["action"] == "insert")
    {
        ...
        $answer = mysqli_real_escape_string($connect,$_POST['answer']);
         $query = "INSERT INTO $tablename(`question`,`answer`)  VALUES ('$question','$answer')";
    ...
    if($_POST["action"] == "update")
    {
        ...
        $query = "UPDATE $tablename SET `question` = '$question',`answer` = '$answer' WHERE id = '".$_POST["image_id"]."'";
        if(mysqli_query($connect, $query))
        {
            echo 'Data Updated!';
        }
