            ...
            <div class="modal-body">
                <form id="image_form" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="Enter First Name">Suburb Name</label>
                        <input class="form-control" type="text" name="name"  placeholder="Enter Suburb Name">
                        </div>
                        
                        <div class="form-group">
                            <label for="exampleFormControlInput1">State/Country</label>
