...
if(isset($_POST["action"]))
{
    if($_POST["action"] == "fetch")
    {
        ...
        $output = '
   <table class="table showing table-bordered table-striped">
    <tr>
     <th width="30%">ID</th>
      <th width="50%">Suburb Name</th>
      <th width="50%">Suburb State</th>
  ...
  $i=0;
   ...
   ';
    ...
    if($_POST["action"] == "insert")
    {
        ...
        $query = "INSERT INTO $tablename(`name`,`state`)  VALUES ('$name','$state')";
    ...
    if($_POST["action"] == "update")
    {
        ...
        $query = "UPDATE $tablename SET `name` = '$name' `state`= '$state' WHERE id = '".$_POST["image_id"]."'";
        if(mysqli_query($connect, $query))
        {
            echo 'Data Updated!';
        }
